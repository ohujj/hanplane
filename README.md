...
5. GitHub Actions와 EC2 기반 배포 자동화
...
로컬 실행 시 application-local.yml이 필요합니다.

실제 secret 값은 Git에 포함하지 않고, 예시 파일인 application-local-example.yml을 제공합니다.
